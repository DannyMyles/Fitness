      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-600">Add a new training program to the Services page</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="One-on-one customized training sessions tailored to your goals..."
                  rows={4}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="From KES 2,000/session"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent"
                    required
                  />
                </div>
          ...
          <div className="adventure-card">
            ...
            <input
              ...
              placeholder="/images/025.JPG"
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent"
              required
            />
            <p className="text-xs text-gray-500 mt-2">
              Path to an existing image in the site (e.g. /images/025.JPG) or a full URL.
            </p>
            {formData.image && (
        ...
        <div className="space-y-6">
          ...
          <div className="adventure-card">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-gray-500 -mt-2">Shows a "Popular" badge on the card</p>
              ...
              <p className="text-xs text-gray-500 -mt-2">Unpublished services are hidden from the public Services page</p>
            </div>
          </div>
